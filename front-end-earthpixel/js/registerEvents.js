...
import { insert, select, startDrawingBuilding, stopDrawingBuilding, reloadWMSBuildingsLayer, clearVectorBuildingsLayer, update, remove} from './buildings';
...
export function registerEvents(){
    ...
    document.getElementById('form-building-update').addEventListener('click',update);
    document.getElementById('form-building-delete').addEventListener('click',remove);
